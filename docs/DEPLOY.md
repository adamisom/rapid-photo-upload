...
## How to Know When Deployment is Done

### Railway Dashboard
1. Go to https://railway.app/dashboard
2. Click on your service (backend or frontend)
3. Check the **Deployments** tab:
   - Status shows "Active" when deployment completes
   - Build logs show progress (Maven build, npm install, etc.)
...
curl -I https://web-frontend-rapid-photo-upload-production.up.railway.app
```

**Typical deployment time:** 3-5 minutes (Maven build + startup)
