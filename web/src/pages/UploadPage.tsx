...
export default function UploadPage() {
  ...
  // ErrorBoundary will catch any rendering errors
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex items-start justify-between">
          ...
          {(files.length > 0 || completedBatches.length > 0) && (
            <button
              onClick={() => {
                if (window.confirm('Clear all upload state? This will remove all files and batch history.')) {
                  reset();
                }
              }}
              className="text-sm text-gray-600 hover:text-red-600 font-medium transition-colors flex items-center space-x-1 px-3 py-2 border border-gray-300 rounded-lg hover:border-red-300"
              title="Clear all files and batch history"
            >
